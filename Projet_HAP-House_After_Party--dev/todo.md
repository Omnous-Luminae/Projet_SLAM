...
[] faire un filtre pour le nombre de réservation (pourquoi pas avec les dates)
[x] voir si tout les formulaire sont bien organisé
[] faire en sorte de pouvoir réserver que si on est connecté
[x] mettre en place une vérif pour savoir si toute les infos sont bien remplie correctement
[] mettre en place un mode sombre et mode jour pour le panel admin
[] faire en sorte de modifier les réservations depuis le fullcalendar
...
[] faire des filtres de recherche pour les formulaires admin
[] compléter le formulaire des points d'intérets
[] faire le full formulaire réservation et la gestion des biens
[] bien refaire la réservation pour la gestion des tarifs
...
[] avoir de meilleur styles pour les formulaires admin
[x] le formulaire locataire doit être mit en nom,prémon,adressse,tel,...
[x] faire en sorte de pouvoir sélectionner plusieures photos avec un drag and drop
[] les prestation c'est pas salle de bain, etc... c'est plutôt terrain de foot,...
[] faire une validation du bien par l'admin
[] lorsque l'on clique sur gérer la composition, on puisse gérer la composition d'uniquement le bien concerné et pas tout les biens
[] faire en sorte de pouvoir faire le gestion des tarifs même en temps qu'admin